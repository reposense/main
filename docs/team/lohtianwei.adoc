...
include::../UserGuide.adoc[tag=showBest2.0]

include::../UserGuide.adoc[tag=changePass2.0]
...
include::../DeveloperGuide.adoc[tag=showbestxi]

include::../DeveloperGuide.adoc[tag=changepass]
