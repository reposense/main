...
// tag::enhancedadd[]
==== Optional field enhancement to existing add command `since v1.1`
...
The sequence diagram below illustrates the operation of the enhancement made to `add` command:
