...
image::RemarkActivityDiagram.png[width="800"]
...
image::TeamCreateSequenceDiagram1.png[width="800"]

.Model Component: Create Sequence Diagram
image::TeamCreateSequenceDiagram2.png[width="500"]
...
image::TeamViewSequenceDiagram.png[width="800"]
...
image::TeamRenameSequenceDiagram1.png[width="800"]

.Model Component: Rename Sequence Diagram
image::TeamRenameSequenceDiagram2.png[width="500"]
...
image::TeamAssignSequenceDiagram.png[width="800"]
...
image::TeamRemoveSequenceDiagram1.png[width="800"]

.Model Component: Remove Sequence Diagram
image::TeamRemoveSequenceDiagram2.png[width="500"]
