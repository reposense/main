...
image::createExampleBefore.png[width="450"]

"Liverpool" will be shown in the Team List.

image::createExampleAfter.png[width="450"]
// end::create[]
...
image::assignExampleList.png[width="450"]
...
image::assignExampleBefore.png[width="450"]

image::assignExampleAfter.png[width="450"]
