...
Format: `toggleprivacy <<Index, INDEX>> FIELD [FIELD]...` +
Alias: `tp`

[NOTE]
====
* Current version of `toggleprivacy` supports the following `FIELD`: +
** Phone: `p/`, Email: `e/`, Address: `a/`, Remark: `r/` & Rating: `ra/`.
====
...
Format: `edit <<Index, INDEX>> [n/NAME] [e/EMAIL] [tm/TEAM] [a/ADDRESS] [p/PHONE_NUMBER] [j/JERSEY_NUMBER] [ra/RATING] [po/POSITION] [t/TAG]...` +
Alias: `e`
...
Format: `assign [TEAM_NAME] i/<<Index, INDEX>> [<<Index, INDEX>>]...` +
Alias: `at`
...
|`tp`
|toggleprivacy INDEX [p/] [e/] [a/] [r/] [ra/]
|toggleprivacy 2 a/
