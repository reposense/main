...
.  Copy the file to the folder you want to use as the home folder for My Team Manager.
...
If you have accidentally called the `undo` command too many times and need a way to quickly reverse that? MTM allows you to redo the most recent `undo` command.
...
Should you want to delete a player from MTM, you may use this command.
