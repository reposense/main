...
|av/AVATAR| Filepath for avatar image file. Eg. C:\image.png (for Windows) or /User/username/path/to/image.jpg(for MacOS)| i/C:\image.png  i//User/username/path/to/image.jpg
