...
=== Appearance and Privacy Commands

Here you can find useful commands to change the look of My Team Manager
such as <<setTagColour, setting the colour of your tags>>, <<changeTeam,changing the theme>>
and also privacy commands to hide sensitive information.
